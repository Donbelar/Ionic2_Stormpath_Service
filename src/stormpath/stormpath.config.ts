...
export class StormpathConstants {
   ...
   * ```
   */
  public static readonly AUTHENTICATION_ENDPOINT: string = '/';
   ...
   */
  public static readonly REGISTER_URI: string = '/applications';
   ...
   * </pre>
   */
  public static readonly ENDPOINT_PREFIX: string = '/api/v1/tenants/1QI0gxrvZNfYAFsamRTwbf';
